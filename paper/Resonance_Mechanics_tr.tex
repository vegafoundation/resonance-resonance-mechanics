...
\title{Resonance Mechanics: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Resonance Mechanics'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
